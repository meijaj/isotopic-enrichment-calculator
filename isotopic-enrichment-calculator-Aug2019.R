  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      wellPanel(tags$style(type="text/css", '.well {width: 85%}'),
        sliderInput("abundance", label = "Explore data by-hand", min=0, max=1, value=0.98, round=TRUE, step=0.01, width='100%'),
    ...
    mainPanel(
      ...
      br(),
      p("NRC Isotopic Enrichment Calculator (2019) v.1.81")
